...
-- В описі датасета сказано, що у рядків зі скасованими замовленнями TransactionNo починається з 'С', а Quantity має відʼємне значення. Перевіримо, чи є рядки, де кількість товару відʼємна, а номер транзакції не починається з 'С' (ні)
